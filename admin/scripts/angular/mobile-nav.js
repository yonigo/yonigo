  ...
  function link(scope, viewElement, attrs) {    
    ...
    function insertPage(page) {
      ...
      if (locals && locals.$template) {
        ...
        //
        /*if ($('.tab-content'))
        	$('.tab-content').height($('.mb-page').height() - $('.mb-page>div:nth-child(1)').height() - 60);
        else
        	$('.mb-page>div:nth-child(2)').height($('.mb-page').height() - $('.mb-page>div:nth-child(1)').height()); // make contant scrollable*/
      }
      page.scope.$emit('$viewContentLoaded');
      //page.scope.$broadcast('$viewContentLoaded');
        ...
        promise.then(function() {
          ...
          if (source) {
            ...
            source = undefined;
        	  ...
        	  $rootScope.$broadcast('firstPageLoaded', dest);
          }
        });
